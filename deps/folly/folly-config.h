...
#ifdef _MSC_VER
#define FOLLY_HAVE_GETTIMEOFDAY 0
#else
...
#ifdef _MSC_VER
#define FOLLY_HAVE_SCHED_YIELD 0
#else
...
#define FOLLY_PACKAGE_STRING "folly 1.0"
#endif
...
#define FOLLY_PACKAGE_VERSION "1.0"
#endif
